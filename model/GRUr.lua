...
--[[
Creates one timestep of one GRUr - modification of GRU layer
where output from the most upper GRU hidden layer goes as 
input to the first GRU hidden layer.
]]--
function GRUr.grur(input_size, rnn_size, n, dropout)
  ...
  for L = 1,n do
    ...
    if L == 1 then
      ...
      local hN2h0 = nn.Linear(rnn_size, rnn_size)(inputs[n+1])
      update_gate = nn.Sigmoid()(nn.CAddTable()({i2h, h2h, hN2h0}))
      reset_gate = nn.Sigmoid()(nn.CAddTable()({i2h, h2h, hN2h0}))
    else
